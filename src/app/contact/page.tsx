            ...
            <div className="w-full max-w-2xl">
              ...
              <AnimatePresence mode="wait">
                ...
                {role === 'project' && (
                  ...
                  >
                    <input type="text" placeholder={t('企业全称与核心实业领域', 'Company Name & Core Industry')} className="w-full bg-transparent border-b border-white/10 pb-4 text-lg focus:outline-none focus:border-white transition-colors text-white placeholder:text-white"/>
                    ...
                    <button className="bg-[#FFFFFF] text-[#000000] px-12 py-5 text-sm font-bold uppercase tracking-widest hover:bg-white w-full transition-colors mt-8">
                ...
                {role === 'institution' && (
                  <motion.div 
                    ...
                    className="space-y-12"
                  >
                    <input type="text" placeholder={t('机构主体名称与资本性质', 'Institution Name & Capital Nature')} className="w-full bg-transparent border-b border-white/10 pb-4 text-lg focus:outline-none focus:border-white transition-colors text-white placeholder:text-white"/>
                    <div className="flex gap-8">
                      <input type="text" placeholder={t('AUM 资产管理规模', 'AUM')} className="w-full bg-transparent border-b border-white/10 pb-4 text-lg focus:outline-none focus:border-white transition-colors text-white placeholder:text-white"/>
                      <input type="text" placeholder={t('投资偏好/赛道', 'Investment Focus')} className="w-full bg-transparent border-b border-white/10 pb-4 text-lg focus:outline-none focus:border-white transition-colors text-white placeholder:text-white"/>
                    </div>
                    <textarea rows={2} placeholder={t('联合投资模型或资金接驳方案简述...', 'Joint Investment Model Overview...')} className="w-full bg-transparent border-b border-white/10 pb-4 text-lg focus:outline-none focus:border-white transition-colors text-white placeholder:text-white resize-none"></textarea>
                    <button className="bg-[#FFFFFF] text-[#000000] px-12 py-5 text-sm font-bold uppercase tracking-widest hover:bg-white w-full transition-colors mt-8">
                ...
                {role === 'media' && (
                  <motion.div 
                    ...
                    className="space-y-12"
                  >
                    <input type="text" placeholder={t('所属媒体、自媒体 IP 或会议品牌背书', 'Media Outlet or Event Brand')} className="w-full bg-transparent border-b border-white/10 pb-4 text-lg focus:outline-none focus:border-white transition-colors text-white placeholder:text-white"/>
                    <input type="text" placeholder={t('合作载体形式', 'Type of Cooperation')} className="w-full bg-transparent border-b border-white/10 pb-4 text-lg focus:outline-none focus:border-white transition-colors text-white placeholder:text-white"/>
                    <textarea rows={3} placeholder={t('详细资源互换方案与核心曝光量级说明...', 'Detailed cooperation proposal...')} className="w-full bg-transparent border-b border-white/10 pb-4 text-lg focus:outline-none focus:border-white transition-colors text-white placeholder:text-white resize-none"></textarea>
                    <button className="border border-white text-white px-12 py-5 text-sm font-bold uppercase tracking-widest hover:bg-white hover:text-black w-full transition-colors mt-8">
